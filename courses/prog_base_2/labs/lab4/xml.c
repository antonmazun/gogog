...
char * list_to_html(list_t list)
{
	...
	char * text = malloc(sizeof (char) * 10000);
	text[0] = '\0';
	strcat(text, "<!DOCTYPE html> <html> <head> <meta charset=\"UTF-8\"> <title>Adminhjs</title> </head> <body> <table> <caption>Admins</caption> <tr> <th>Id</th> <th>Name</th> <th>Surname</th> <th>Birthdate</th> <th>Rate</th> <th>Creating year</th> <th>Followers</th> </tr>");
	for (int i = 0;i < list_size(list); i++)
	{
		if (list_get(list, i) == NULL)
			continue;
...
char * list_to_html_id(list_t list, int i)
{
	...
	char * text = malloc(sizeof (char) * 10000);
	text[0] = '\0';
	strcat(text, "<!DOCTYPE html> <html> <head> <meta charset=\"UTF-8\"> <title>Adminu</title> </head> <body> <table> <caption>Adminu</caption> <tr> <th>Id</th> <th>Name</th> <th>Surname</th> <th>Birthdate</th> <th>Rate</th> <th>Creating year</th> <th>Followers</th> </tr>");
	if (list_get(list, i) == NULL)
		return NULL;
	//<tr> <th>Id</th> <th>Name</th> <th>Surname</th> <th>Birthdate</th> <th>Rate</th> <th>Creating year</th> <th>Followers</th> </tr>");
	strcat(text, "<tr> <th>");
