...
**
** Created: Mon 9. May 00:04:06 2016
...
static const char qt_meta_stringdata_Reg[] = {
    "Reg\0\0on_pushButton_clicked()\0"
};
...
const QMetaObjectExtraData Reg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Reg::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Reg,
      qt_meta_data_Reg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Reg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Reg))
